...
#define PROPERTY_TIME       "date_time"
...
public slots:
    ...
    void onDateTimeValueChanged(QtProperty *property, const QDateTime &val);
    void onEnumValueChanged(QtProperty *property, int val);
    void onFlagValueChanged(QtProperty *property, int val);
...
private:
    ...
    QtProperty *createFlagProperty(const bool &isReadOnlay, const std::string &attrName, const Json::Value &initValue, const Json::Value &curValue);
    ...
    QtProperty *createDateTimeProperty(const bool &isReadOnlay, const std::string &attrName, const Json::Value &initValue, const Json::Value &curValue);
...
private:
    ...
    QtDateTimePropertyManager *mDateTimeManager;    //时间管理
    QtFlagPropertyManager *mFlagManager;
