...
class QTPROPERTYBROWSERSHARED_EXPORT QtVariantProperty : public QtProperty
{
public:
    ~QtVariantProperty();
...
class QTPROPERTYBROWSERSHARED_EXPORT QtVariantPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class QTPROPERTYBROWSERSHARED_EXPORT QtVariantEditorFactory : public QtAbstractEditorFactory<QtVariantPropertyManager>
{
    Q_OBJECT
public:
