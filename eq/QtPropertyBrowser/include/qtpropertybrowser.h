...
class QTPROPERTYBROWSERSHARED_EXPORT QtProperty
{
public:
    virtual ~QtProperty();
...
class QTPROPERTYBROWSERSHARED_EXPORT QtAbstractPropertyManager : public QObject
{
    Q_OBJECT
public:
...
class QTPROPERTYBROWSERSHARED_EXPORT QtAbstractEditorFactoryBase : public QObject
{
    Q_OBJECT
public:
...
class QTPROPERTYBROWSERSHARED_EXPORT QtAbstractEditorFactory : public QtAbstractEditorFactoryBase
{
public:
...
class QTPROPERTYBROWSERSHARED_EXPORT QtBrowserItem
{
public:
...
class QTPROPERTYBROWSERSHARED_EXPORT QtAbstractPropertyBrowser : public QWidget
{
    Q_OBJECT
public:
