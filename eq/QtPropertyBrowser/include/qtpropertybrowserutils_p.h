...
class QTPROPERTYBROWSERSHARED_EXPORT QtCursorDatabase
{
public:
    QtCursorDatabase();
    void clear();
...
class QTPROPERTYBROWSERSHARED_EXPORT QtPropertyBrowserUtils
{
public:
...
class QTPROPERTYBROWSERSHARED_EXPORT QtBoolEdit : public QWidget {
    Q_OBJECT
public:
