#ifndef FRAMEMIDDLE_H
#define FRAMEMIDDLE_H

#include "framemiddle_global.h"
...
namespace Pf
{
    ...
    {
        class FRAMEMIDDLESHARED_EXPORT frameMiddle : public frameObj
        {
            enum{
                Info_Word_0,
                Info_Word_1,
        ...
        extern "C"
        {
           ...
           * @return 类指针
           */
           FRAMEMIDDLESHARED_EXPORT frameObj *LoadClass();
        }
    }
}
