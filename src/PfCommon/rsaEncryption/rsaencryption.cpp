...
namespace Pf
{
    namespace PfCommon
    {
        bool rsaEncryption::createRsaKey(QString& strPubKey, QString& strPriKey)
        {
        ...
        QString rsaEncryption::rsaPriEncryptBase64(const QString& strClearData, const QString& strPriKey)
        {
        ...
        QString rsaEncryption::rsaPubDecryptBase64(const QString& strDecryptData, const QString& strPubKey)
        {
        ...
        QString rsaEncryption::rsaPubEncryptBase64(const QString& strClearData, const QString& strPubKey)
        {
            QByteArray pubKeyArry = strPubKey.toUtf8();
            uchar* pPubKey = (uchar*)pubKeyArry.data();
        ...
        QString rsaEncryption::rsaPriDecryptBase64(const QString& strDecryptData, const QString& strPriKey)
        {
            QByteArray priKeyArry = strPriKey.toUtf8();
            uchar* pPriKey = (uchar*)priKeyArry.data();
