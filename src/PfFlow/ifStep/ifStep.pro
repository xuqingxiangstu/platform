...
win32:CONFIG(release, debug|release): TARGET = ../../../../stepLib/ifStep
else:win32:CONFIG(debug, debug|release): TARGET = ../../../../stepLib/ifStep
else:unix:!macx: TARGET = ../../../stepLib/ifStep
