    ...
    std::thread exeThread([&]()
    {
        ...
        try
        {
            ...
            for (auto itor = mRunVec.begin(); itor != mRunVec.end(); ++itor)
            {
                ...
                strCode.str("");
                strCode << "{\"msgType\":\"cmd\",\"msg\":{\"type\":\"showMsg\",\"status\":true,\"show\":\"" << strFormat + des + strFormat << "\"}}";
        ...
        if(allTestRes)
            updateMsg("{\"msgType\":\"cmd\",\"msg\":{\"type\":\"over\",\"param\":true}}");
        else
            updateMsg("{\"msgType\":\"cmd\",\"msg\":{\"type\":\"over\",\"param\":false}}");
