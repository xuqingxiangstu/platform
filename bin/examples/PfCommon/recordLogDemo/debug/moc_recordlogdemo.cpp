/****************************************************************************
** Meta object code from reading C++ file 'recordlogdemo.h'
**
...
#include "../../../../../examples/PfCommon/recordLogDemo/recordlogdemo.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'recordlogdemo.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 9), // "recordSig"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 3) // "msg"

    },
    "workThread\0recordSig\0\0msg"
};
...
void workThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recordSig((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&workThread::recordSig)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void workThread::recordSig(QByteArray _t1)
{
